    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 w-full max-w-xl">
      {prompts.map((suggestion, index) => (
        <button
          ...
          className="flex items-start gap-2.5 text-left rounded-xl border border-[var(--sf-border-default)] bg-[var(--sf-surface-card)] px-4 py-3 text-sm motion-safe:animate-scale-in transition-[border-color,background-color,transform] duration-150 hover:border-primary-500/50 hover:bg-[var(--sf-surface-raised)] hover:-translate-y-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
        >

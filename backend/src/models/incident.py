...
from src.models.enums import IncidentType, SeverityLevel, enum_column
...
class Incident(Base):
    ...
    severity: Mapped[SeverityLevel] = mapped_column(enum_column(SeverityLevel, length=20), nullable=False)
    incident_type: Mapped[IncidentType] = mapped_column(enum_column(IncidentType, length=30), nullable=False)
